...
export function meta() {
  return [
    { title: "Página no encontrada | FarmaciasHoy.cl" },
  ];
}
          ...
          <div className="p-8 md:p-10 grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="mt-3 text-brand-muted">
                Lo sentimos, la ruta que buscaste no existe o fue movida. Vuelve al inicio para seguir navegando.
              </p>
              ...
              <div className="mt-6 text-xs text-brand-muted">
                Código: <span className="font-semibold text-brand-dark">404</span> · Si crees que es un error,{" "}
                <a href="mailto:soporte@tusitio.cl?subject=Reporte%20404" className="underline hover:no-underline">
                  contáctanos
                </a>.
              </div>
            </div>
